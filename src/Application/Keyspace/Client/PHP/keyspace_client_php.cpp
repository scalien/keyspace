...
ZEND_NAMED_FUNCTION(_wrap_Keyspace_SetExpiry) {
  ...
  }
  {
    if(SWIG_ConvertPtr(*args[2], (void **) &tmp3, SWIGTYPE_p_unsigned_long_long, 0) < 0 || tmp3 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 3 of Keyspace_SetExpiry. Expected SWIGTYPE_p_unsigned_long_long");
    }
    arg3 = *tmp3;
  }
...
ZEND_NAMED_FUNCTION(_wrap_Keyspace_ClearExpiries) {
  ClientObj arg1 = (ClientObj) 0 ;
  int result;
  zval **args[1];
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, 0, 0) < 0) {
      ...
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Keyspace_ClearExpiries. Expected SWIGTYPE_p_p_void");
    }
  }
...
static function_entry keyspace_client_functions[] = {
 ...
 ZEND_NAMED_FE(keyspace_clearexpiries,_wrap_Keyspace_ClearExpiries,NULL)
