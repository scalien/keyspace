...
static swig_type_info _swigt__p_p_void = {"_p_p_void", "ResultObj *|ClientObj *|void **", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_void = {"_p_void", "ResultObj|ClientObj|void *", 0, 0, (void*)0, 0};
...
ZEND_NAMED_FUNCTION(_wrap_imaxdiv_t_quot_get) {
  ...
  {
    long long * resultobj = new long long((const long long &) result);
...
ZEND_NAMED_FUNCTION(_wrap_imaxabs) {
  ...
  {
    intmax_t * resultobj = new intmax_t((const intmax_t &) result);
    SWIG_SetPointerZval(return_value, (void *)resultobj, SWIGTYPE_p_long_long, 1);
  }
  return;
fail:
...
ZEND_NAMED_FUNCTION(_wrap_strtoimax) {
  ...
  /*@SWIG:/usr/share/swig1.3/php4/utils.i,26,CONVERT_STRING_IN@*/
  ...
  /*@SWIG:/usr/share/swig1.3/php4/utils.i,7,CONVERT_INT_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_strtoumax) {
  ...
  {
    uintmax_t * resultobj = new uintmax_t((const uintmax_t &) result);
...
ZEND_NAMED_FUNCTION(_wrap_Keyspace_DistributeDirty) {
  ...
  /*@SWIG:/usr/share/swig1.3/php4/utils.i,2,CONVERT_BOOL_IN@*/
...
static zend_function_entry keyspace_client_functions[] = {
 SWIG_ZEND_NAMED_FE(imaxdiv_t_quot_set,_wrap_imaxdiv_t_quot_set,NULL)
 SWIG_ZEND_NAMED_FE(imaxdiv_t_quot_get,_wrap_imaxdiv_t_quot_get,NULL)
 SWIG_ZEND_NAMED_FE(imaxdiv_t_rem_set,_wrap_imaxdiv_t_rem_set,NULL)
 SWIG_ZEND_NAMED_FE(imaxdiv_t_rem_get,_wrap_imaxdiv_t_rem_get,NULL)
 SWIG_ZEND_NAMED_FE(new_imaxdiv_t,_wrap_new_imaxdiv_t,NULL)
 SWIG_ZEND_NAMED_FE(imaxabs,_wrap_imaxabs,NULL)
 SWIG_ZEND_NAMED_FE(imaxdiv,_wrap_imaxdiv,NULL)
 SWIG_ZEND_NAMED_FE(strtoimax,_wrap_strtoimax,NULL)
 SWIG_ZEND_NAMED_FE(strtoumax,_wrap_strtoumax,NULL)
 SWIG_ZEND_NAMED_FE(new_keyspace_nodeparams,_wrap_new_Keyspace_NodeParams,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_nodeparams_close,_wrap_Keyspace_NodeParams_Close,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_nodeparams_addnode,_wrap_Keyspace_NodeParams_AddNode,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_nodeparams_nodec_set,_wrap_Keyspace_NodeParams_nodec_set,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_nodeparams_nodec_get,_wrap_Keyspace_NodeParams_nodec_get,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_nodeparams_nodes_set,_wrap_Keyspace_NodeParams_nodes_set,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_nodeparams_nodes_get,_wrap_Keyspace_NodeParams_nodes_get,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_nodeparams_num_set,_wrap_Keyspace_NodeParams_num_set,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_nodeparams_num_get,_wrap_Keyspace_NodeParams_num_get,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_resultbegin,_wrap_Keyspace_ResultBegin,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_resultnext,_wrap_Keyspace_ResultNext,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_resultisend,_wrap_Keyspace_ResultIsEnd,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_resultclose,_wrap_Keyspace_ResultClose,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_resultkey,_wrap_Keyspace_ResultKey,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_resultvalue,_wrap_Keyspace_ResultValue,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_resulttransportstatus,_wrap_Keyspace_ResultTransportStatus,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_resultconnectivitystatus,_wrap_Keyspace_ResultConnectivityStatus,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_resulttimeoutstatus,_wrap_Keyspace_ResultTimeoutStatus,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_resultcommandstatus,_wrap_Keyspace_ResultCommandStatus,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_create,_wrap_Keyspace_Create,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_init,_wrap_Keyspace_Init,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_destroy,_wrap_Keyspace_Destroy,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_getresult,_wrap_Keyspace_GetResult,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_setglobaltimeout,_wrap_Keyspace_SetGlobalTimeout,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_setmastertimeout,_wrap_Keyspace_SetMasterTimeout,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_getglobaltimeout,_wrap_Keyspace_GetGlobalTimeout,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_getmastertimeout,_wrap_Keyspace_GetMasterTimeout,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_getmaster,_wrap_Keyspace_GetMaster,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_distributedirty,_wrap_Keyspace_DistributeDirty,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_get,_wrap_Keyspace_Get,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_dirtyget,_wrap_Keyspace_DirtyGet,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_count,_wrap_Keyspace_Count,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_countstr,_wrap_Keyspace_CountStr,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_dirtycount,_wrap_Keyspace_DirtyCount,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_dirtycountstr,_wrap_Keyspace_DirtyCountStr,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_listkeys,_wrap_Keyspace_ListKeys,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_listkeysstr,_wrap_Keyspace_ListKeysStr,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_dirtylistkeys,_wrap_Keyspace_DirtyListKeys,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_dirtylistkeysstr,_wrap_Keyspace_DirtyListKeysStr,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_listkeyvalues,_wrap_Keyspace_ListKeyValues,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_listkeyvaluesstr,_wrap_Keyspace_ListKeyValuesStr,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_dirtylistkeyvalues,_wrap_Keyspace_DirtyListKeyValues,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_dirtylistkeyvaluesstr,_wrap_Keyspace_DirtyListKeyValuesStr,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_set,_wrap_Keyspace_Set,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_testandset,_wrap_Keyspace_TestAndSet,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_add,_wrap_Keyspace_Add,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_addstr,_wrap_Keyspace_AddStr,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_delete,_wrap_Keyspace_Delete,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_remove,_wrap_Keyspace_Remove,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_rename,_wrap_Keyspace_Rename,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_prune,_wrap_Keyspace_Prune,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_setexpiry,_wrap_Keyspace_SetExpiry,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_removeexpiry,_wrap_Keyspace_RemoveExpiry,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_begin,_wrap_Keyspace_Begin,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_submit,_wrap_Keyspace_Submit,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_cancel,_wrap_Keyspace_Cancel,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_isbatched,_wrap_Keyspace_IsBatched,NULL)
 SWIG_ZEND_NAMED_FE(keyspace_settrace,_wrap_Keyspace_SetTrace,NULL)
{NULL, NULL, NULL}
};
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(keyspace_client_globals_id);
#endif
    return SUCCESS;
}
