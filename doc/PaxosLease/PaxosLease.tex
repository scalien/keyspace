...
PaxosLease is used for master lease negotiation in Scalien Software's Keyspace replicated key-value store. Since Keyspace is licensed under the open-source BSD license, this reference implementation, which contains many practical optimizations, is freely available to all interested readers. The source code and binaries may be downloaded at \texttt{http://scalien.com}.
