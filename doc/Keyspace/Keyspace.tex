...
\item \texttt{COUNT(prefix, startKey, count, next)}: returns the number of items the same \texttt{LIST} operation with the same arguments would return.
