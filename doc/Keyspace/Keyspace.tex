...
\item \texttt{DIRTY-LIST-KEYVALUES(prefix, n)}: same as \texttt{LIST-KEY-VALUES}, but without making any consistency guarantees about reflecting previous write operations.
\end{itemize}
